    ...
    return (
        <>
            ...
            <div className="mb-5 lg:w-1/2 text-left">
                <div className="mb-5">
                    Option 1) Receive all of your initially deposited BOMB immediately upon unlock and forfeit your
                    bonus BOMB tokens. You will still receive BOMBSWAP tokens as a reward for your participation in the
                    lock bonus!
                </div>
                <div className="mb-5">
                    Option 2) Receive 50% of your initially deposited BOMB back immediately. The remainder of your BOMB
                    (other 50% of initially deposited + ALL Bonus BOMB) is immediately put into auto vaults where the
                    entire balance earns APR’s during its stake period. These stake positions will be vested over the
                    course of 6 months with small portions being released daily. A few important points on this option.
                    Firstly, this option benefits the BOMB ecosystem as a whole as it helps BOMB asset prices rise as a
                    function of how the LPs work. Secondly, with more and more people selecting option 2, it’s very
                    likely that the price of the assets in these vaults will continue to rise. Finally, zapping all of
                    this BOMB into these specific LPs does not lower the price of BOMB.
                </div>
