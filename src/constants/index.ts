import { ChainId, JSBI, Percent, Token, WETH } from '@bombswap/sdk'
...
export const BOMB: { [key: string]: Token } = {
    ...
    USDC: new Token(ChainId.BOMB, '0x75942DD8bD0C6F845a647E0Fa157b5725077960D', 18, 'USDC', 'USDC'),
    WBTC: new Token(ChainId.BOMB, '0x140F62aCCC69cb24eABdC0E00b7caaC577cA5b24', 18, 'BTC', 'BTC'),
    WETH: new Token(ChainId.BOMB, '0x128E2b86F42BDB3B646D9B9666B8F8E9cdcEC495', 18, 'WETH', 'Wrapped Ethereum'),
    BNB: new Token(ChainId.BOMB, '0xfA74D6D13575751C2eb3d4960CD2A164303893d2', 18, 'BNB', 'BNB'),
    USDT: new Token(ChainId.BOMB, '0x0FCbc0baCaD8C73be4Fad141682542b44C4737bB', 18, 'USDT', 'USDT'),
...
export const SUGGESTED_BASES: ChainTokenList = {
    ...
    [ChainId.BOMB]: [...WRAPPED_NATIVE_ONLY[ChainId.BOMB], BOMB.BUSD, BOMB.BOMBSWAP],
...
export const ANALYTICS_URL: { [chainId in ChainId]?: string } = {
    [ChainId.BOMB]: 'https://info.bombswap.xyz',
    [ChainId.MAINNET]: '',
    [ChainId.MATIC]: '',
    [ChainId.FANTOM]: '',
    [ChainId.BSC]: '',
